...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TB_CSS = [
			...
			'.dsh-tb-panel { position:absolute; z-index:2; padding:12px; border:1px solid var(--dsw-alias-border-l1); border-radius:13px; background:var(--dsw-alias-bg-layer-1); box-shadow:0 12px 34px rgba(0,0,0,.35); }',
			...
			'.dsh-tb-card.dsh-tb-completed { border-color:var(--dsw-alias-state-success-primary); background:linear-gradient(color-mix(in srgb, var(--dsw-alias-state-success-primary) 22%, transparent), color-mix(in srgb, var(--dsw-alias-state-success-primary) 22%, transparent)), var(--dsw-alias-bg-layer-1); }',
			'.dsh-tb-card-temporary { min-height:112px; border-style:dashed; background:linear-gradient(color-mix(in srgb, #e7a84b 20%, transparent), color-mix(in srgb, #e7a84b 20%, transparent)), var(--dsw-alias-bg-layer-1); }',
